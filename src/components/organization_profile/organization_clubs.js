  ...
  return (
    <div className="Modal-About">
      <div className="d-flex justify-content-between align-items-center">
        ...
        <span
          data-toggle="modal"
          data-target=".organizationclubs-bd-example-modal-lg"
        ...
        <div className="row">
          {experiences.map((data) => (
            <DepartmentElement
              ...
              dept_image={data.data.Attachment}
              dept_members="500"
              key={data.data.key}
            />
          ))}
      ...
      <div
        class="modal fade organizationclubs-bd-example-modal-lg "
        tabindex="-1"
        role="dialog"
              ...
              <form>
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    value={Input.email}
                    name="email"
                    placeholder="Enter Name of H.O.D"
                  />
                </div>
                <div class="form-group">
                  <label for="orgclubdescription">About</label>
                  <textarea
                    ...
                    type="text"
                    class="form-control"
                    id="orgclubdescription"
                    name="description"
                    onChange={handleInput}
                    value={Input.description}
                    placeholder="Enter Few lines About Club"
                  />
                </div>
                <div class="form-group">
                  <label>Profile Pic</label>
